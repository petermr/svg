...
public class ImageConverterTest {
	...
	public void testCreateImageFromHref() throws IOException {
		...
		Assert.assertEquals("image", "<image xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xlink:href=\"iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAMklEQVR42mP4J8LwHx0zAAE2cWzyeBUSgxnw2UwMnzouINVmnF4YwmEwmg7Is3kYhQEA6pzZRchLX5wAAAAASUVORK5CYII=\" />", svgElement.toXML());
	...
	public void testCreateHref() throws IOException {
		...
		Assert.assertEquals("svgString", 
				...
				+ "  <image  x=\"0.0\" y=\"0.0\"    width=\"16.0\" height=\"16.0\"    "
				+ "xlink:href=\"../target/images/image.1.png\"   /></svg>",
				svgString);
