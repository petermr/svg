...
public class Path2ShapeConverterTest {
	...
	// IGNORED (should probably be deleted)
	
//	private final static Logger LOG = Logger.getLogger(Path2ShapeConverterTest.class);
//	
//	@Test
...
//
//
//	/** IGNORED because of compile fail
//	@Test
